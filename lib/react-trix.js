...
var TrixEditor = (function (_super) {
    ...
    function TrixEditor(props) {
        ...
        _this.handleTagSelected = _this.handleTagSelected.bind(_this);
        return _this;
    }
    ...
    TrixEditor.prototype.handleTagSelected = function (t) {
        var state = this.state;
    ...
    TrixEditor.prototype.renderTagSelector = function (tags) {
        ...
        var selectOptions = tags.map(function (t) { return { label: t.name, value: t.tag }; });
        var placeholder = "Select " + this.state.mergeTagSet + "...";
        return (React.createElement("div", { style: boxStyle, className: "react-trix-suggestions" },
            React.createElement(react_select_1.default, { autoFocus: true, name: "merge_tag_selector", placeholder: placeholder, value: this.state.selectedMergeTag, options: selectOptions, onChange: this.handleTagSelected, clearable: false })));
    };
